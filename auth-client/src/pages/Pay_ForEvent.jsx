  ...
  const [bookingDetails, setBookingDetails] = useState([]);
    const getBookingDetails = async () => {
        try {
            ...
            const res = await axios.get(`http://localhost:8000/api/v1/booking/getBookingForEvent/${id.id}`);
            if(res.data.success) {
                setBookingDetails(res.data.data.bookingForEvent)
            }
        } catch (error) {
            console.log(error);
        }
        ...
        <div className="pay_ForEvent">
           ...
           <div className="w-full mx-auto pt-[16vh]">
               <div className="ease-in duration-300 w-[80%] sm:w-max shadow-sm backdrop-blur-md bg-white/80 lg:w-max mx-auto rounded-md px-8 py-5 mb-8" >
                  ...
                  <div className="mt-6 border-t border-gray-100">
                    <dl className="divide-y divide-gray-100">
                        ...
                        <div className="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd className="mt-1 font-bold text-lg text-end leading-6 sm:col-span-2 sm:mt-0 text-[#142850]"> ₹2099 </dd>
                        </div>
                ...
                <Link to="https://buy.stripe.com/test_aEU7sT4BXdB35tSbIL">
